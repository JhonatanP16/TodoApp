...
const tasksSlice = createSlice({
    ...
    reducers:{
        ...
        createDirectory(state,action){
            ...
            const diretoryAlredyExists = state.directories.includes(newDirectory);
            if(diretoryAlredyExists) return;
        ...
        editDirectoryName(state,action){
            ...
            const direcetoryAlreadyExists = state.directories.includes(newDirName);
            if(direcetoryAlreadyExists) return;
